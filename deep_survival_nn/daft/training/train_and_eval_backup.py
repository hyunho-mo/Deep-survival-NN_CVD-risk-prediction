...
def train_and_evaluate(
    ...
    for i in range(num_epochs):
        ...
        if evaluator is not None:
            ...
            torch.save(model, os.path.join(trained_model_dir, '%s_trained_network_%s.pth' %(discr_net, outcome)))
    ...
    if evaluator is not None:
      ...
      plt.legend()
      plt.savefig(os.path.join(figure_dir, 'training_loss_curve_%s_%s.png' %(discr_net, outcome)))
      ...
      plt.legend()
      plt.savefig(os.path.join(figure_dir, 'training_cindex_curve_%s_%s.png' %(discr_net, outcome)))
